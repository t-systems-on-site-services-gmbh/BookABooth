                        ...
                        <div class="form-group">
                          ...
                          <div class="row mt-2">
                            <div class="col-md-6">
                              ...
                              <div
                                v-if="
                                  v$.settingsAccount.company.billingZipCode.$anyDirty && v$.settingsAccount.company.billingZipCode.$invalid
                                "
                              >
                            ...
                            <div class="col-md-6">
                              ...
                              />
                              <div
                                v-if="v$.settingsAccount.company.billingCity.$anyDirty && v$.settingsAccount.company.billingCity.$invalid"
                              >
